...
<head>
    ...
    <!-- The above 3 meta tags *must* come first f the head; any other head
   ...
   <link href="css/mycss.css" rel="stylesheet" id="theme-stylesheet">
                  ...
                  <div class="row">
                      ...
                      <div class="col-xs-7">
                          ...
                          <div class="login">
                              ...
                              <a href="signUp.html"><i class="fa fa-user"></i> <span class="hidden-xs text-uppercase">Sign up</span></a>
                          </div>
                  ...
                  <div class="container">
                      <div class="navbar-header">
                          ...
                          <a class="navbar-brand home" href="index.html">
                              <img src="image/logo1.png" alt="Universal logo" class="hidden-xs hidden-sm" width="187" height="65">
                              <img src="image/bookbot1.png" alt="Universal logo" class="visible-xs visible-sm" width="110" height="47"><span class="sr-only">Universal - go to homepage</span>
                          </a>
                      ...
                      <div class="navbar-collapse collapse" id="navigation">
                          ...
                          <ul class="nav navbar-nav navbar-right">
                              <li class="">
                                  <a href="index.html" class="dropdown-toggle" >Home <b class=""></b></a>
                              ...
                              <li class="">
                                  <a href="aboutus.html" class="dropdown-toggle" >About Us<b class=""></b></a>

                              </li>


                              <li class="">
                                  <a href="contact.html" class="dropdown-toggle" >Contact <b class=""></b></a>
        ...
        <div class="col-md-6">
          ...
          <form>
              <div class="input-group">
                  ...
                  <input type="text" class="form-control" placeholder="Join our monthly newsletter">
            ...
            <div class="col-md-6">
              <p class="pull-right">&copy; 2016. BookBot.org</p>
